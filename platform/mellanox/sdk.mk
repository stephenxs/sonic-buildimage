...
MLNX_SDK_SOURCE_BASE_URL = http://arc-build-server/sdk/sx_sdk_eth-$(MLNX_SDK_VERSION)/SOURCES/
...
WJH_LIBS_DBGSYM = sx-acl-helper-dbgsym_1.mlnx.$(MLNX_SDK_DEB_VERSION)_amd64.deb
ifeq ($(SDK_FROM_SRC),y)
